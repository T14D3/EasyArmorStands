...
<<<<<<< Updated upstream:easyarmorstands-plugin/src/main/java/me/m56738/easyarmorstands/util/Util.java
=======
    ...
    public static ItemStack createTool() {
        ItemStack item = createItem(
                ItemType.BLAZE_ROD,
                Component.text("Armorstand-Tool", NamedTextColor.GOLD),
                Arrays.asList(
                        Component.text("Rechtsklick auf einen Armorstand zum bearbeiten", NamedTextColor.GRAY),
                        Component.text("Linksklick zum Abwählen des aktuellen Körperteils", NamedTextColor.GRAY),
                        Component.text("Fallen lassen zum beenden", NamedTextColor.GRAY)
                )
        );
    ...
    public static boolean isTool(ItemStack item) {
        ...
        return meta.getDisplayName().equals(ChatColor.GOLD + "Armorstand-Tool");
    }
...
>>>>>>> Stashed changes:src/main/java/me/m56738/easyarmorstands/util/Util.java
